...
// echo $arr['money'];
// echo "<br>";
// echo xiazhumoney(114);


//$arr = file_get_contents(stripslashes($cfg_jnd));  //去除对象里面的斜杠
//$srr = json_decode($arr,true);
//print_r($srr);

// 设置url
// $url = 'https://d.caijuapi.com/News?token=ceqlbctjfjlnndzf&name=jnd28';
//  function get_http_codes($url) {
//   $curl = curl_init();
