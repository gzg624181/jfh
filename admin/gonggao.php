...
<form name="form" id="form" method="post" action="shoukuan_save.php">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dataTable">
		...
		<tr align="left" class="dataTr">
			...
			<td align="left" style="padding:8px;"><?php echo $row['content']; ?></td>
			<td align="center"><span class="number"><?php echo date("Y-m-d H:i:s",$row['issuetime']); ?></span></td>
			<td align="center">
            <div id="jsddm"><a title="删除" href="active_save.php?action=del3&id=<?php echo $row['id'];?>&action=del_gonggao" onclick="return ConfDel(0);"><i class="fa fa-trash" aria-hidden="true"></i></a></div>
